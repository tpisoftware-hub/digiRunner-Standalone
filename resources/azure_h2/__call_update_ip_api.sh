...
#   --insecure
    ...
    local api_response2=$(curl -s -k -X POST "$API_URL" \
        ...
        -H "authorization: Bearer $access_token" \
        -H 'content-type: application/json' \
        --data '{"ReqHeader":{"txSN":"","txDate":"","txID":"","cID":"","locale":""},"ReqBody":{"id":"TSMP_EDITION","oldVal":"Cn88-nNTO-8xx8-uCuF-88nV-9occ-\u0021S4x-8\u0021\u0021r-nF\u0021r-Fn\u0021#-xL\u0021=-8\u0021#e-\u0021=8\u0021-#x\u0021=-L\u0021#c-\u0021=\u0021\u0021-\u0021\u0021\u0021\u0021-","newVal":"Ce88-nRPO-exx8-GMue-88ni-Hoed-\u0021B4x-x\u0021Cr-nx\u0021r-Fn\u0021#-xU\u0021=-x\u0021#8-\u0021=8\u0021-#d\u0021=-n\u0021#n-\u0021=\u0021\u0021-\u0021\u0021\u0021\u0021-","memo":"","encrptionType":"NONE"}}')
