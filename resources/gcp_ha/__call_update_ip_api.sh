...
#   --insecure
    ...
    local api_response5=$(curl -s -k -X POST "$API_URL" \
        ...
        -H "authorization: Bearer $access_token" \
        -H 'content-type: application/json' \
        --data "{\"ReqHeader\":{\"txSN\":\"\",\"txDate\":\"\",\"txID\":\"\",\"cID\":\"\",\"locale\":\"\"},\"ReqBody\":{\"id\":\"DGRKEEPER_IP\",\"oldVal\":\"127.0.0.1\",\"newVal\":\"main-dgr-service\",\"memo\":\"DGRKEEPER Server Host\",\"encrptionType\":\"NONE\"}}")
